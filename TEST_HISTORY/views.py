    ...
    if request.method == 'POST':
        ...
        for banfe_id in test_ids:
            ...
            full_row =  [
                ...
                banfe_details['data_banfe']['encoded_labyrinths']['cross'] if applied_areas['orbitomedial'] else 'N.A.',
                banfe_details['data_banfe']['encoded_game']['percentage_risk_cards'] if applied_areas['orbitomedial'] else 'N.A.',
                banfe_details['data_banfe']['encoded_game']['total_score'] if applied_areas['orbitomedial'] else 'N.A.',
                banfe_details['data_banfe']['encoded_stroopA']['stroop_errors'] if applied_areas['orbitomedial'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_stroopA']['time'] if applied_areas['orbitomedial'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['natural_stroopA']['successes'] if applied_areas['orbitomedial'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_stroopB']['stroop_errors'] if applied_areas['orbitomedial'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_stroopB']['time'] if applied_areas['orbitomedial'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['natural_stroopB']['successes'] if applied_areas['orbitomedial'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_cards']['maintenance_error'] if applied_areas['orbitomedial'] else 'N.A.',
                banfe_details['scores']['encoded_orbitomedial'] if applied_areas['orbitomedial'] else 'N.A.',
                banfe_details['data_banfe']['encoded_semantic']['abstract_categories'] if applied_areas['prefrontal'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_sayings']['time'] if applied_areas['prefrontal'] and banfe_details['proceeding_age'] >= 10 else 'N.A.',
                banfe_details['data_banfe']['natural_sayings']['successes'] if applied_areas['prefrontal']  and banfe_details['proceeding_age'] >= 10 else 'N.A.',
                banfe_details['data_banfe']['encoded_metamemory']['positive_errors'] if applied_areas['prefrontal'] else 'N.A.',
                banfe_details['data_banfe']['encoded_metamemory']['negative_errors'] if applied_areas['prefrontal'] else 'N.A.',
                banfe_details['scores']['encoded_prefrontal'] if applied_areas['prefrontal'] else 'N.A.',
                banfe_details['data_banfe']['encoded_signaling']['perseverations'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_signaling']['time'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['natural_signaling']['successes'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_substraction']['time_a'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['natural_substraction']['successes_a'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_substraction']['time_b'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 10 else 'N.A.',
                banfe_details['data_banfe']['natural_substraction']['successes_b'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 10 else 'N.A.',
                banfe_details['data_banfe']['encoded_addition']['time'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['natural_addition']['successes'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_ordering']['essays_first_list'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_ordering']['essays_second_list'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                ...
                banfe_details['data_banfe']['natural_memory']['maximum_sequence'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_memory']['perseverations'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['data_banfe']['encoded_memory']['order_errors'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 8 else 'N.A.',
                banfe_details['scores']['work_memory'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_labyrinths']['caught'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_labyrinths']['time'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['natural_cards']['successes'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_cards']['perseverations'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_cards']['deferred_perseverations'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_cards']['time'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_semantic']['total_categories'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_semantic']['total_average'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_semantic']['total_score'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_fluency']['successes'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_fluency']['perseverations'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_towers']['movements_first'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_towers']['time_first'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['data_banfe']['encoded_towers']['movements_second'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 10 else 'N.A.',
                banfe_details['data_banfe']['encoded_towers']['time_second'] if applied_areas['dorsolateral'] and banfe_details['proceeding_age'] >= 10 else 'N.A.',
                banfe_details['scores']['executive_functions'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['scores']['encoded_dorsolateral'] if applied_areas['dorsolateral'] else 'N.A.',
                banfe_details['scores']['encoded_total'] if all_applied_areas else 'N.A.'                
            ]
